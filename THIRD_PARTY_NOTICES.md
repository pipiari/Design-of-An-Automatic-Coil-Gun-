# Third-party materials and reuse

No blanket license is applied. On September 25, 2026, Michael confirmed the publication checks covering included code and screenshot permission. That confirmation authorizes their inclusion in this portfolio; it does not select an open-source license or extend permission to excluded datasets, weights, or other assets. Public availability is not presented as a grant of unrestricted reuse rights.

| Material | Relationship to this release |
| --- | --- |
| Arduino SoftwareSerial | Referenced by the serial example; library not bundled |
| OpenMV | Described as a subsystem; libraries and tutorial illustrations not bundled |
| Ultralytics / YOLO | Described in the history; packages, weights, and training code not bundled |
